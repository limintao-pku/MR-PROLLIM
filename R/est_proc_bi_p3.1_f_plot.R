est_proc_bi_p3.1_f_plot<-function(beta,m_matrix,post_sample_k1,post_sample_k1_exp1,post_sample_k2,post_sample_k2_exp1,post_sample_p,
                                  g1_matr,g2_matr,sigma_prime_list,sign_k1,sign_k2,
                                  p1_sp=NULL,p2_sp=NULL,r_sp=NULL,model_u2=T,log_appr=2,t_b1=F){
  if(t_b1){
    b1_t<-beta[1]
  }else{
    b1<-beta[1]
